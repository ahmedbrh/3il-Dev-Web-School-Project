...
<!-- notre base de données contenant deux tables: utilisateur et commentaire -->
<!-- la table utilisateur permet l'inscription et l'identification -->
<!-- la table commentaire permet d'ajouter et d'appeler les commentaires -->
